...
describe DummiesController do
  ...
  context "with json" do
    ...
    # TODO: Write tests to ensure formats html/json are not called if not enabled

    it "POST #create" do
      dummy_params = FactoryGirl.attributes_for(:dummy)
      
      expect{post :create, dummy: dummy_params, format: :json}.to change(Dummy, :count).by(1)
    end
